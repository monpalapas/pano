...
import { Loader2, AlertCircle, Copy, Download, Check, X } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {images.map((image) => (
            ...
            >
              ...
              <div className="absolute top-3 right-3 bg-sky-500 text-white text-xs font-bold px-2 py-1 rounded-full">
                360°
              </div>
            </div>
          ))}
